...
SECTION_BY_ENDPOINT = {
    ...
    'models_index': SECTION_PROJECTS,
    'api_models_list': SECTION_PROJECTS,
    'model_detail': SECTION_PROJECTS,
    'model_edit': SECTION_PROJECTS,
    'model_upload_version': SECTION_PROJECTS,
    'model_download_latest': SECTION_PROJECTS,
    'model_download_version': SECTION_PROJECTS,
    'model_view_version': SECTION_PROJECTS,
    'model_upload_thumbnail': SECTION_PROJECTS,
    'serve_thumbnail': SECTION_PROJECTS,
    ...
    'project_template_data': SECTION_PROJECTS,
    ...
    'bambu_job_duplicate': SECTION_PRINTERS,
    ...
    'backup_trigger_now': SECTION_SETTINGS,
    'backup_list_files': SECTION_SETTINGS,
    'backup_download_file': SECTION_SETTINGS,
    'backup_delete_file': SECTION_SETTINGS,
    ...
    'maintenance_duplicate': SECTION_PRINTERS,
    'maintenance_schedule_30': SECTION_PRINTERS,
    'maintenance_resolve_fault': SECTION_PRINTERS,
    'maintenance_ics': SECTION_PRINTERS,
    'maintenance_data': SECTION_PRINTERS,
    ...
    'waste_records_partial': SECTION_FILAMENTS,
    'waste_add_ajax': SECTION_FILAMENTS,
    'waste_edit_ajax': SECTION_FILAMENTS,
    'waste_delete_ajax': SECTION_FILAMENTS,
    'waste_data_ajax': SECTION_FILAMENTS,
    'waste_upload_ajax': SECTION_FILAMENTS,
    'waste_delete_file_ajax': SECTION_FILAMENTS,
...
def _audit_target():
    ...
    explicit = {
        ...
        'model_detail': (ProjectFile, 'root_id'),
        'model_edit': (ProjectFile, 'root_id'),
        'model_upload_version': (ProjectFile, 'root_id'),
        'model_download_latest': (ProjectFile, 'root_id'),
        ...
        'maintenance_duplicate': (PrinterMaintenance, 'rec_id'),
        'maintenance_schedule_30': (PrinterMaintenance, 'rec_id'),
        'maintenance_resolve_fault': (PrinterMaintenance, 'rec_id'),
