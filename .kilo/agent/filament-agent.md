...
- Run `python -m pytest tests/ -v --tb=short -n auto` after implementation (parallel execution via pytest-xdist).
...
8. ✅ **ARCHITECTURE UPDATE** — Update `.kilo/ARCHITECTURE.md`, `README.md`, `.github/copilot-instructions.md` if needed (Rule 29)
