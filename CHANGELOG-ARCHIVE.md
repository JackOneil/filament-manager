# Changelog Archive (v1.100.0 and older)

This file contains changelog entries for versions **v1.100.0 through v1.0.0**.
For recent versions (v1.101.0+), see the main [CHANGELOG.md](CHANGELOG.md).
